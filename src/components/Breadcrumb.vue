<template>
  <!-- Breadcrumb Start -->
  <div class="flex items-center relative bg-no-repeat bg-scroll bg-center bg-cover lg:mb-32 md:mb-20 mb-15 h-365 md:h-460 lg:h-500" style="background-image:url(public/images/bg/breadcrumbs-bg.webp);">
    <div class="container">
      <div class="relative 2xl:pt-20 lg:pt-16 pt-12 md:mb-12 z-10 flex flex-col justify-center items-center text-center">
        ...
        <ul class="flex">
          <li>
            <router-link class="text-white uppercase text-base sm:text-lg font-bold mr-2 transition-all hover:text-primary" to="/">Home</router-link>
          </li>
          <li>
