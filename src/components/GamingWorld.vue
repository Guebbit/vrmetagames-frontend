...
export default defineComponent({
  ...
  data() {
    return {
      ...
      services: [
        {
          imgSrc: "public/images/others/gaming-world1.webp",
          name: "Service Image",
          live: "Live Streaming",
          text: "When unknown printer took type and scrambled it to make type specimen book centuries,",
          videoBannerBg: "public/images/others/gaming-world-bg1.webp"
        },
        {
          imgSrc: "public/images/others/gaming-world2.webp",
          name: "Service Image",
          live: "Game News",
          text: "When unknown printer took type and scrambled it to make type specimen book centuries,",
          videoBannerBg: "public/images/others/gaming-world-bg2.webp"
        },
        {
          imgSrc: "public/images/others/gaming-world3.webp",
          name: "Service Image",
          live: "Game Tournaments",
          text: "When unknown printer took type and scrambled it to make type specimen book centuries,",
          videoBannerBg: "public/images/others/gaming-world-bg3.webp"
        }
      ]
    }
  },
