<template>
  <div class="flex flex-col mr-12 xl:mr-100">
    ...
    <router-link to="/" class="mb-10">
      <img src="public/images/logo.webp" alt="Footer Logo">
    </router-link>
    <!-- Footer Logo End -->
      ...
      links: [
        {
          ...
          BgShape: "public/images/icon/facebook-bg.webp",
          className: "icofont-facebook text-white"
        },
        {
          href: "https://www.dribble.com",
          BgShape: "public/images/icon/dribble.webp",
          className: "icofont-dribbble text-white"
        },
        {
          href: "https://www.youtube.com",
          BgShape: "public/images/icon/youtobe-bg.webp",
          className: "icofont-youtube-play text-white"
        },
        {
          href: "https://www.twitter.com",
          BgShape: "public/images/icon/twittre.webp",
