        ...
        <form id="contact-form" 
            ...
            <div class="single-fild col-span-2">
                ...
                <div class="form-btn-wrap flex justify-center w-full mt-16">
                    <button type="submit" value="submit" name="submit" class="form-btn group primary-btn opacity-100 transition-all uppercase" style="background-image:url(public/images/others/btn-bg.webp)">
                        {{btnName}}
